...
class CompositeMessageField( SBEMessageField ):
    ...
    def __init__( self, description=None, field_length=None, field_offset=None, float_value=False, id=None, name=None, message_type_name=None, parts=None, semantic_type=None, since_version=0 ):
        super().__init__()
    ...
    def wrap( self, buffer, offset ):
        ...
        relative_offset = 0
        for part in self.parts:
            schema_name_id = f'{self.message_type_name}/{self.id}'
    ...
    def create( field_type_map, field_definition, field_offset, endian='<' ):
        ...
        for child in field_type[ 'children' ]:
            ...
            composite_field = TypeMessageField( constant=constant, description=child.get( 'description', '' ), field_length=primitive_type_size, field_offset=field_offset, name=child[ 'name' ], null_value=null_value, optional=optional, message_type_name=child[ 'name' ], semantic_type=field_semantic_type, since_version=child_since_version, unpack_fmt=unpack_fmt, )
        ...
        return CompositeMessageField( description=field_description, field_length=field_length, field_offset=field_offset, float_value=is_float_composite, id=field_id, name=field_name, message_type_name=field_schema_name, parts=composite_parts, semantic_type=field_semantic_type, since_version=field_since_version, )
